...
export const SEND_EMAIL_API_URL = isProduction
  ...
  : "/api/send_email";
export const CLASSIFIER_ROOT_API_URL = isProduction
  ? "https://classifier-production-a03a.up.railway.app/"
  : "/api/classifier-root";
export const UPDATE_CRM_API_URL = isProduction
  ? "https://pipedriveupdater-production.up.railway.app/update_crm"
  : "/api/update_crm";
